...
?>
	...
	<?php if ( have_comments() ) : ?>
		<h2 id="comments-title">
			<?php
				printf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'esquire' ),
		...
		<nav id="comment-nav-above">
			...
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'esquire' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'esquire' ) ); ?></div>
		</nav>
