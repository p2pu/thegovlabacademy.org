...
<section id="respond" class="respond-form">
	...
	<h3 id="comment-form-title" class="h2"><?php comment_form_title( __( 'We would love to hear from you. Share ideas and resources, ask questions, prompt discussion.', 'bonestheme' ), __( 'Leave a Reply to %s', 'bonestheme' )); ?></h3>
